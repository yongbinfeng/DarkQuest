...
int RecoE1039Sim(const int nevents = 10,
                 const int isim = 1,
                 const int igun = 0,
                 ...
                 std::string input_file = "Brem_2.750000_z500_600_eps_-7.5",
                 std::string input_path = "/seaquest/users/yfeng/DarkQuest/DarkQuest/lhe/output/displaced_Aprime_Muons/",
...
{
  std::cout << "Running RecoE1039Sim with the following parameters: " << std::endl;
  std::cout << "nevents: " << nevents << std::endl;
  std::cout << "isim: " << isim << std::endl;
  std::cout << "igun: " << igun << std::endl;
  std::cout << "zvertex: " << zvertex << std::endl;
  std::cout << "do_displaced_tracking: " << do_displaced_tracking << std::endl;
  std::cout << "do_analysis: " << do_analysis << std::endl;
  std::cout << "run_pileup: " << run_pileup << std::endl;
  std::cout << "input_file: " << input_file << std::endl;
  std::cout << "input_path: " << input_path << std::endl;
  std::cout << "out_file: " << out_file << std::endl;
  std::cout << "out_path: " << out_path << std::endl;
  std::cout << "pileup_file: " << pileup_file << std::endl;
